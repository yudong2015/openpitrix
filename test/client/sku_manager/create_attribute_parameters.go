...
type CreateAttributeParams struct {
	...
	/*Body*/
	Body *models.OpenpitrixCreateAttributeRequest
...
// WithBody adds the body to the create attribute params
func (o *CreateAttributeParams) WithBody(body *models.OpenpitrixCreateAttributeRequest) *CreateAttributeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create attribute params
func (o *CreateAttributeParams) SetBody(body *models.OpenpitrixCreateAttributeRequest) {
	o.Body = body
}
