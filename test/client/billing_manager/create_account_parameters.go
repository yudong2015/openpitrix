...
type CreateAccountParams struct {
	...
	/*Body*/
	Body *models.OpenpitrixCreateAccountRequest
...
func (o *CreateAccountParams) WithBody(body *models.OpenpitrixCreateAccountRequest) *CreateAccountParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create account params
func (o *CreateAccountParams) SetBody(body *models.OpenpitrixCreateAccountRequest) {
	o.Body = body
}
